...
a.comments.create(body:"Nice eagle you've got there.", user: maureen)
b.comments.create(body:"Cardinal in winter. Very nice.", user: dan)
c.comments.create(body:"I get a lot of hummingbirds around where I live.", user: jeff)
